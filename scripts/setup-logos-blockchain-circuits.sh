...
#
# Arguments:
#   VERSION      - Optional. Version to install (default: v0.5.6)
...
#   ./setup-logos-blockchain-circuits.sh v0.5.6             # Install specific version to default location
#   ./setup-logos-blockchain-circuits.sh v0.5.6 /opt/circuits  # Install to custom location
