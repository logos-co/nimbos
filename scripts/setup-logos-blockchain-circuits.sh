...
#
# Arguments:
#   VERSION      - Optional. Version to install (default: v0.5.3)
...
#   ./setup-logos-blockchain-circuits.sh v0.5.3             # Install specific version to default location
#   ./setup-logos-blockchain-circuits.sh v0.5.3 /opt/circuits  # Install to custom location
